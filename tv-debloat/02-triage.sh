...
P_G1='^com\.google\.android\.backdrop$|^com\.google\.android\.tungsten\.setupwraith$|^com\.google\.android\.tungsten\.overscan$|^com\.google\.android\.feedback$|^com\.google\.android\.printservice\.recommendation$|^com\.google\.android\.partnersetup$|^com\.google\.android\.onetimeinitializer$|^com\.google\.android\.syncadapters\.|^com\.android\.wallpaper|^com\.android\.dreams|daydream|screensaver|^com\.android\.bookmarkprovider$|^com\.android\.printspooler$|^com\.android\.easteregg$|^com\.google\.android\.music$|^com\.google\.android\.videos$|^com\.google\.android\.apps\.magazines$|^com\.google\.android\.apps\.books$|^com\.google\.android\.play\.games|^com\.netflix\.ninja$|^com\.amazon\.amazonvideo|^com\.disney\.disneyplus$|^com\.spotify\.tv|^com\.rakuten|^com\.pluto|^tv\.molotov|^com\.viacom|^de\.dwelle|^com\.dailymotion|^tv\.twitch|^com\.hbo|^com\.plexapp|^com\.deezer|^com\.tidal|demo$|\.demo\.|retaildemo|oobe|^com\.google\.android\.apps\.mediashell$|analytics|telemetry|crashreport'

# --- Grupo 2: pregúntale al usuario si de verdad los usa --------------------
P_G2='^com\.google\.android\.youtube|^com\.google\.android\.katniss$|^com\.google\.android\.apps\.tv\.dreamx$|^com\.google\.android\.tvrecommendations$|^com\.google\.android\.gms\.location\.history$|^com\.google\.android\.marvin\.talkback$|^com\.google\.android\.tts$|^com\.android\.chrome$|^com\.google\.android\.googlequicksearchbox$|^com\.google\.android\.apps\.photos|^com\.google\.android\.calendar|^com\.google\.android\.apps\.chromecast|^com\.google\.android\.apps\.mediarouter|cast|assistant|^com\.android\.bips$|^com\.android\.cellbroadcast|^com\.android\.emergency$|^com\.android\.traceur$|^com\.google\.android\.apps\.youtube\.music'
